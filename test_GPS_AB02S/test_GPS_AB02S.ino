...
uint8_t devEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x05, 0xFC, 0x33 };
uint8_t appEui[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
uint8_t appKey[] = { 0x55, 0x51, 0x41, 0x8B, 0x29, 0xAE, 0x24, 0x31, 0x73, 0x5F, 0xC2, 0xE3, 0xCD, 0x1D, 0x2E, 0x11 };

uint32_t devAddr = ( uint32_t)0x260BE291;
uint8_t nwkSKey[] = { 0x66, 0x40, 0xBB, 0x96, 0x8E, 0xAA, 0x7A, 0xDB, 0x96, 0x45, 0x6F, 0x77, 0x7F, 0xD0, 0xDB, 0x6E };
uint8_t appSKey[] = { 0xC7, 0x5E, 0x61, 0x62, 0x71, 0xFC, 0x90, 0x4A, 0x95, 0xAF, 0x3D, 0xBA, 0xB2, 0x92, 0xEA, 0x89 };
