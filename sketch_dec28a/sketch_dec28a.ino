...
const char *wifiSSID = "cma_gate_controller";                  // Your WiFi network name
const char *wifiPassword = "@@cmacma@@";          // Your WiFi network password
const char *otaPassword = "";                       // OTA update password
const char *mqttServer = "192.168.15.48";            // Your MQTT server IP address
const char *mqttUser = "magazyn";                          // mqtt username, set to "" for no user
const char *mqttPassword = "dupcia1";                      // mqtt password, set to "" for no password
const String mqttNode = "PiotrekSkoda";              // Your unique hostname for this device
